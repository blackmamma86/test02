...
public class UserController {
	...
	public String signup(@Valid UserForm userForm, BindingResult bindingResult, HttpServletResponse response) {
		...
		// 1. 토큰 2개 발급 (엑세스는 7일짜리, 리플레시틑 30일짜리
		// 1-1. 현재시간 + 특정시간 = 만료시간으로 엑세스 토큰 발급
		// String accessToken = this.tokenProvider.generateToken(snsUser,
		// Duration.ofDays(7));
		...
		// FIXME #REFACT : 쿠키 생성 및 설정 코드를 모듈화하여 대체
		...
		// 4. 자동 로그인을 미지원하므로, 로그인 화면으로 자동 리다렉트 처리
